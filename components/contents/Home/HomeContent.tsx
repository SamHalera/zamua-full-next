      ...
      <div className="flex flex-col px-8 sm:px-10 md:px-24 lg:px-48 mx-auto sm:mb-4 md:mb-14 lg:mb-16">
        <div className="text-xl leading-9 mb-9">
          ...
          <p className=" italic">
            ...
            listened to jazz radio shows. I recall Louis Armstrong&apos;s
            trumpet playing in the mornings while we ate breakfast, as well as
            the vocals of Ladysmith Black Mambazo, Tracy Chapman, Luigi Tenco,
            Lucio Dalla, and Fabrizio De André.
          </p>
